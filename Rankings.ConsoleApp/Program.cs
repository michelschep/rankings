...
//            Console.WriteLine("================================");
            ...
            for (int elo = 0; elo < 400; elo += 100)
            {
                ...
                var oneSetChance = EloCalculator.ExpectationOneSet(1200, 1200 + elo);
                var resultChance = EloCalculator.ChanceOfHavingThisResult(2, 1, oneSetChance);
                Console.WriteLine($"2-1 => {oneSetChance}/{resultChance}");
                resultChance = EloCalculator.ChanceOfHavingThisResult(1, 2, oneSetChance);
                Console.WriteLine($"1-2 => {oneSetChance}/{resultChance}");
                resultChance = EloCalculator.ChanceOfHavingThisResult(3, 0, oneSetChance);
                Console.WriteLine($"3-0 => {oneSetChance}/{resultChance}");
                resultChance = EloCalculator.ChanceOfHavingThisResult(0, 3, oneSetChance);
